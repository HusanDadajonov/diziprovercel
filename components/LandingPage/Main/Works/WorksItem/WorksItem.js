function WorksItem({item}) {
  ...
  return (
    <div className={`works__item`}>
        <img className="works__img" src={`https://edu.yamo.uz//uploads/images/${item.user_image_src}`} alt="" />
        <div className="works__person">
            <img className="works__person--avatar" src={`https://edu.yamo.uz//uploads/images/${item.user_image_src}`} alt="" />
